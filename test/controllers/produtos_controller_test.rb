...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { data_compra: @produto.data_compra, nome: @produto.nome, quantidade: @produto.quantidade, valor: @produto.valor } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { data_compra: @produto.data_compra, nome: @produto.nome, quantidade: @produto.quantidade, valor: @produto.valor } }
